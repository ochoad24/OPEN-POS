...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if (vm.$v.$invalid) {
        ...
        axios
          ...
          .then(() => {
            vm.loading = false;
            vm.$toastr.s("Producto actualizado exitosamente");
    ...
    getProduct(){
      ...
      vm.loading = true;
      axios
          .get(`/api/products/${vm.$route.query.id}`)
          .then((response)=>{
            vm.name=response.data.name;
            vm.price= response.data.price;
            vm.priceSale= response.data.priceSale;
            vm.priceMinSale= response.data.priceMinSale;
            vm.profitShow= response.data.profit;
            vm.profit= response.data.profit;
            vm.code= response.data.code;
            vm.description= response.data.description;
            vm.stock= response.data.stock;
            vm.idProduct= response.data.id;
            vm.loading = false;
          }).catch((error)=>{
            console.log(error);
            vm.loading = false;
